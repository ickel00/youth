...
//葫芦音乐txq
function hlyytxq(timeout = 0) {
  return new Promise((resolve) => {
let url = {
        url : `https://play.gxhuancai.com/hlplay/user/activeDay?ut=eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI4MDY1NTY2Mjc1OTEzNzExNjE2Iiwic3ViIjoiLXBtRXI5TGZONmtNQzFjVzZMb3BqRTFXYld6bU01Z1JnIiwiaWF0IjoxNjE5MzkxODk4LCJleHAiOjE2MjcxNjc4OTh9.SNPrBWiadh8w0Lfr5fAqsgzPOS7evUbn1baNHybGD2k`,
        headers : JSON.parse(hlyyhd),
}
      $.post(url, async (err, resp, data) => {
...
'timestamp' : `1620887091918`
    ...
    const result = JSON.parse(data)
        ...
        console.log(`\n〔获得葫芦转盘成功，获得金币：${result.data.award} ！〕`)
		await $.wait(30000);
		await hlyyzp2();
...
'timestamp' : `1620887162727`
    ...
    const result = JSON.parse(data)
        ...
        console.log(`\n〔获得葫芦转盘翻倍成功，获得金币：${result.data.extra} ！〕`)
